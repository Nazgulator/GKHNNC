...
namespace GKHNNC.Controllers
{
    public class OsmotrWorksController : Controller
    {
        ...
        {
            var osmotrWorks = db.OsmotrWorks.Include(o => o.DOMPart).Include(o => o.Izmerenie);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,IzmerenieId,Cost,DOMPartId")] OsmotrWork osmotrWork)
        {
